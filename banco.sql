...
--
-- Host: 127.0.0.1
-- Generation Time: 08-Dez-2018 às 20:43
...
INSERT INTO `candidato` (`id_candidato`, `nome`, `numero`, `voto`, `id_partido`) VALUES
(1, 'zezi', 123, NULL, NULL),
(2, 'ze', 234, NULL, NULL),
(3, 'zezin', 12345, NULL, NULL),
(4, 'Zezinho', 1234, NULL, NULL),
(5, '1', 123, NULL, NULL),
(6, 'Junin', 0, NULL, NULL),
(7, 'Dale', 12345, NULL, NULL),
(8, '1245', 1244, NULL, NULL);
...
INSERT INTO `partido` (`id_partido`, `nome`) VALUES
(3, 'PSB'),
(4, 'PSB');
